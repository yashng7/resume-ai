import {  TemplateNames } from "@/app/(main)/editor/TemplateButton";
import { z } from "zod";
...
export type EduDescription = NonNullable<
...
export type CertificationInfo = NonNullable<
...
export const generateEduDescriptionSchema = z.object({
  description: z
    .string()
    .trim()
    .min(1, "Required")
...
export type GenerateEduDescriptionInput = z.infer<
  typeof generateWorkExperienceSchema
>;
